...
This robot is the manager for this area. He was built to maintain the servers and keep the virus from taking complete control over the systems.#layout:left #portrait:default #speaker:I.S.P.
...
Plan B. You can drain all the energy of this robot, without energy the robot will stop doing anything, however, the robot’s energy contains virus.
